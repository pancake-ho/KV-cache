#!/usr/bin/env bash
#SBATCH -J lora-p3b-eval
#SBATCH -p batch_eebme_ugrad
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-gpu=8
#SBATCH --mem-per-gpu=29G
#SBATCH --time=08:00:00
#SBATCH -o runs/topic_eval/slurm-%j.out
#SBATCH -e runs/topic_eval/slurm-%j.err

set -euo pipefail

PROJECT_DIR="/data/surt321/repos/lab/kv_cache/baseline/lora_exp"
WORK_DIR="/local_datasets/${USER}/lora_exp/phase3b_topic_eval_${SLURM_JOB_ID}"
HF_ROOT="/local_datasets/${USER}/hf_cache/lora_phase3b_topic_eval_${SLURM_JOB_ID}"

cd "${PROJECT_DIR}"

mkdir -p runs/topic_eval
...
python scripts/09_eval_topic_adapters.py \
