...
WORK_DIR="/local_datasets/${USER}/lora_exp/phase3b_topic_train_${SLURM_JOB_ID}"
HF_ROOT="/local_datasets/${USER}/hf_cache/lora_phase3b_topic_train_${SLURM_JOB_ID}"

cd "${PROJECT_DIR}"

mkdir -p runs/topic_train
