...
python -m xmodel_kv.cli.extract \
  ...
  --output work/crosskv_qwen3_17b_to_4b/source \
  --role source \
  --stride 4 \
  --device-map cuda:0 \
  --attn-implementation sdpa

cat work/crosskv_qwen3_17b_to_4b/source/metadata.json
du -sh work/crosskv_qwen3_17b_to_4b/source
